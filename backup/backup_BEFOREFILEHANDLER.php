...
//Project Variables
$inputfile = "cdrimport.txt"; // Input file from which the cdr will be read
$outputfile = "cdrexport.txt"; // Output file in which the reconstructed cdr will be placed
$_fill = "_"; // Delimiter for use in the output
